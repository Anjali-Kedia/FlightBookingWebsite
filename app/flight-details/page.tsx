// import FlightComponent from '@/components/FlightDetailComp';
...
//     </div>
//       <FlightComponent flights={flightData} price={price} />
//       <FlightComponent flights={flightData2} price={price2} />
